...
public class OVRGrabber : MonoBehaviour
{
    ...
    protected virtual void MoveGrabbedObject(Vector3 pos, Quaternion rot, bool forceTeleport = false)
    {
        ...
        #region Testing for  Null Reference Exception
        if (grabbedRigidbody == null)
        {
            // Didn't use Debug.LogError as it throws an error and makes the game stop
            Debug.LogWarning("Nsr:: grabbedRigidbody is Null");
            return;
        }
        else if (grabbablePosition == null)
            print("grabbablePosition");
        else if (grabbableRotation == null)
            print("grabbableRotation");
        #endregion
